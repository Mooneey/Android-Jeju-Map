...
import com.example.afinal.SocialBoard.Features.UpdatePostInfo.PostUpdateDialogFragment;
import com.example.afinal.SocialBoard.Features.UpdatePostInfo.PostUpdateListener;
...
public class PostListRecyclerViewAdapter extends RecyclerView.Adapter<CustomViewHolder> {
    ...
    public CustomViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.social_post_item, parent, false);
    ...
    public void onBindViewHolder(CustomViewHolder holder, int position) {
        ...
        holder.editButtonImageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                postUpdateDialogFragment.show(((SocialPostListActivity) context).getSupportFragmentManager(), Config.UPDATE_POST);
            }
        });
    }
