 ...
 * 작성자 : 2018038041 김서빈
 * 작성일 : 2020.06.19
 * 프로그램 설명 : 살어리랏다 in Jeju의 사업자용 선택 후 회원가입 시 이메일과 비밀번호 입력해서 firbase에 저장
 ************************************************/
...
public class SignUpActivity_Business extends AppCompatActivity {
        ...
        public void onClick(View v) {
            switch (v.getId()){
                case R.id.signUpButton:
                    singUP();
                    myStartActivity(MemberInitActivity_Business.class);
                    finish();
                    break;
            }
        }
